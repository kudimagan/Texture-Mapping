...
colourRGB trace (Vector3 point, Vector3 dir, colourRGB lightColorRGB, Vector3 lightloc, int mode, bool ill = false)
{
	colourHSV surface;
	colourRGB sRGB;
	...
	// Ambient light
	sRGB = convertHSV2RGB(surface);
	sRGB = sRGB * att + colourRGB(Ia, Ia, Ia) * ka;
