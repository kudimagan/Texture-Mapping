...
namespace objl
{
	...
	namespace algorithm
	{
        ...
        bool rayTriangleIntersect(const Vector3 &orig, const Vector3 &dir,const Vector3 &v0, const Vector3 &v1, const Vector3 &v2,double &t,double &u,double& v)
		{
			...
			Vector3 vp1 = P - v1;
			C = math::CrossV3(edge1,vp1);
			if ((u = math::DotV3(N,C)) < 0){return false;} // P is on the right side

			// edge 2
			Vector3 edge2 = v0 - v2;
			Vector3 vp2 = P - v2;
			C = math::CrossV3(edge2,vp2);
			if ((v = math::DotV3(N,C)) < 0){return false;} // P is on the right side;
			u /= denom;
			v /= denom;
...
struct colourHSV{
   ...
   double h,s,v;
   colourHSV(double r=0,double g=0,double b=0)
   {
     h=r;
     s=g;
     v=b;
...
struct colourRGB{
   ...
   double r,g,b;
   colourRGB(double rr=0,double gg=0,double bb=0)
   {
      r = rr;
      g = gg;
      b = bb;
